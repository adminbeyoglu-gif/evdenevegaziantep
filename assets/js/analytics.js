/* Google Analytics 4 (gtag.js)
   ...
   Teshis: sayfayi ?debug=1 ile acin -> GA4 DebugView'a kaydeder. */
...
(function(){
 ...
 function yukle(){
  ...
  s.onerror=function(){ if(window.console) console.warn('[GA] gtag.js YÜKLENEMEDİ — reklam engelleyici veya tarayıcı izleme koruması engelliyor olabilir.'); };
